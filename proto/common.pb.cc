...
const ::_pbi::DescriptorTable descriptor_table_proto_2fcommon_2eproto = {
    false, false, 3245, descriptor_table_protodef_proto_2fcommon_2eproto,
    "proto/common.proto",
